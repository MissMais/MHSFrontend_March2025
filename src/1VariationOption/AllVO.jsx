...
//     const fetchVO = async () => {
//         try {
//             const response = await axios.get('http://localhost:2000/VariationOption')
...
//         <div className='card'>
//         <div className='card-title text-center calsname fw-bold '>Variation Option</div>

//             <div className='card-body'>
//             <ul className='list-group'>{VO.map((VO)=>(
//                 <li key={VO.id} className='list-group-item d-flex justify-content-between align-items-center'>
//                     <div>
//                     <strong>option_id: </strong>{VO.option_id}<br />
//                     <strong>variation_id: </strong>{VO.variation_id} <br />
//                     <strong>value: </strong>{VO.value} <br />
//                     <strong>color_code: </strong>{VO.color_code} <br />
                   
//                     </div>
//                     <div>
//                     <button className='btn btn-primary btn-sm' onClick={()=>ButtonDelete(VO.id)}>DELETE</button>
//                     <button className='btn btn-success btn-sm ms-3' onClick={()=>editVO(VO.id)}>EDIT</button>
//                     </div>
//                 </li>
//             ))}
