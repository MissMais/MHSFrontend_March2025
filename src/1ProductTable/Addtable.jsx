...
export default function Addtable() {
    ...
    const saveData = async (data) => {
        try {
            ...
            const response = await axios.post('https://3rn4qfbv-8000.inc1.devtunnels.ms/product/', payload, {
                headers: {
    ...
    return (
        <div className="container mt-4">
          <form onSubmit={handleSubmit(saveData)}>
            <div className="mb-4">
              <label htmlFor="Product_Description" className="block text-sm font-semibold text-gray-700">Product Description</label>
              <input
              ...
              />
              {errors.Product_Description && <p className="text-red-500 text-sm">Product Description is required</p>}
            </div>
      
            <div className="mb-4">
              <label htmlFor="Sub_Category_id" className="block text-sm font-semibold text-gray-700">Sub Category Id</label>
              <input
                ...
                className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
              {errors.Sub_Category_id && <p className="text-red-500 text-sm">Sub Category Id is required</p>}
            </div>
