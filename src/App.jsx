      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route
              path="/addC"
              element={<PrivateRoute element={<AddC />} />}
            />

            <Route
              path="/allC"
              element={<PrivateRoute element={<AllC />} />}
            />
            ...
            <Route
              path="/addSC"
              element={<PrivateRoute element={<AddSC />} />}
            />

            <Route
              path="/allSC"
              element={<PrivateRoute element={<AllSC />} />}
            />
            ...
            <Route
              path="/alltable"
              element={<PrivateRoute element={<Alltable />} />}
            />
          ...
          <Route
            path="/allvo"
            element={<PrivateRoute element={<VariationOptionCRUD />} />}
          />
{/* 
          <Route
            path="/addvo"
            element={<PrivateRoute element={<AddVO />} />}
          />

          <Route
            path='/editvo/:id'
            element={<PrivateRoute index element={<EditVO />} />}
          /> */}
