  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen mt-14 bg-gray-100">
      ...
      <div className="w-full md:w-1/6 bg-white p-6 shadow-">
        <h2 className="text-xl font-bold mb-6" style={{ fontFamily: "Copperplate, Papyrus, fantasy", color: "#666F80" }}>
          Account Settings
        </h2>
      ...
      <div className="w-full md:flex-1 p-8 bg-white shadow-md rounded-md">
        <h1 className="text-3xl font-bold mb-6" style={{ fontFamily: "Copperplate, Papyrus, fantasy", color: "#666F80" }}>
          Profile
        </h1>
